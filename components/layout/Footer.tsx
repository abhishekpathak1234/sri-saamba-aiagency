...
const services = [
  ...
  { label: "Lead Qualification", href: "/services#leads" },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <p className="text-muted-foreground text-sm leading-relaxed mb-6 max-w-xs">
              Intelligent AI solutions that automate your workflows, qualify
            ...
            <div className="flex items-center gap-3">
              ...
              <a
                href="#"
                aria-label="Twitter"
                className="w-9 h-9 flex items-center justify-center rounded-lg border border-border hover:border-primary/50 hover:bg-primary/10 transition-colors text-muted-foreground hover:text-primary"
              >
        ...
        <div className="mt-12 pt-8 border-t border-border flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-sm text-muted-foreground">
            © {new Date().getFullYear()} Sri Saamba AI Agency. All rights reserved.
          </p>
